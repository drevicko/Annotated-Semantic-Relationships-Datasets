...
The data is in protobuf form. Third party code for converting to tsv can be found [here](https://github.com/knightBoy/riedel_dataset). I make no claim to that code, please take care if you decide to use it.
